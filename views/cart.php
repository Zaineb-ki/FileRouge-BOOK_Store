                    ...
                    <div class="row">
                        <div class="col-6">
                            <form method="post" action="<?php echo BASE_URL;?>emptycart">
                                <button type="submit" class="btn" style="background-color: #F7C248 ; color: #464545 ; font-family: Josefin Sans, Regular Roman; font-size:15px">
                        ...
                        <div class="col-6">
                            <form method="post" id="addOrder" action="<?php echo BASE_URL;?>addOrder">
                                <button type="submit" class="btn" style="background-color: #D4ECFF ; color: #464545 ; font-family: Josefin Sans, Regular Roman; font-size:15px">
