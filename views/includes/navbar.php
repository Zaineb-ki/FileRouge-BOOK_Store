<div class="container">
  ...
  <a class="navbar-brand" href="<?php echo BASE_URL;?>"> <img style="width: 170px;" src="public\uploads\Logo.png" alt="BOOK STORE"></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo BASE_URL;?>Books">Produits</a>
      </li>
      <li class="nav-item active">
